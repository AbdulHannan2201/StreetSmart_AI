                        ...
                        {bookings.map((booking) => (
                            <div key={booking._id} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col lg:flex-row gap-8">
                                ...
                                <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {/* Defect Analysis */}
                                    <div className={`p-4 rounded-xl border ${booking.defectAnalysis?.defect_detected ? "bg-red-50 border-red-200" : "bg-green-50 border-green-200"}`}>
                                        ...
                                        {booking.defectAnalysis ? (
                                            <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                    {booking.defectAnalysis.defect_detected ? "⚠️ Defect Detected" : "✅ No Defects"}
                                                </div>
                                                {booking.defectAnalysis.defect_detected && (
                                                    <p className="text-sm text-gray-700">Type: {booking.defectAnalysis.defect_type}</p>
                                                )}
                                            </div>
                                        ) : (
